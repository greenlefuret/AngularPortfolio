...
@Component({
  selector: 'app-projets',//selection du app specifique
  templateUrl: './projets.component.html',//chargement de l'html
  styleUrls: ['./projets.component.css']  //chargement du css
})
